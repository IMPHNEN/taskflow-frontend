...
<div on:click={close} class="fixed top-0 left-0 w-full h-full bg-black/30 flex items-center justify-center z-50">
    <div on:click|stopPropagation class="flex flex-col gap-4 bg-white rounded-lg shadow w-1/2 overflow-hidden">
        ...
        <div class="flex flex-col gap-4 bg-white pb-4 px-4">
            <div class="flex items-center justify-between gap-3">
                <div class="flex items-center gap-2">
                    ...
                    <h2 class="font-medium">Edit Task</h2>
                </div>
            ...
            <form class="grid grid-cols-2 gap-6">
                ...
                <div class="flex flex-col gap-2 col-span-2">
                    <label class="text-gray-500 text-sm">Checklist</label>
                    <input 
                        type="text"
